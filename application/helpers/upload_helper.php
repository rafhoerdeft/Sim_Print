...
if (!function_exists('upload_photo')) {
    function upload_photo($name_post = '', $size_file = 1024, $overwrite = false, $path_file = '', $width = '', $height = 250, $thumb = FALSE, $new_path_save='')
    {
        $CI = &get_instance();

        if ($new_path_save == '') {
            $new_path_save = $path_file;
        }
        ...
        if ($upload['respons']) {
            ...
            $config['new_image']        = $new_path_save;
