...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?= base_url() ?>assets/img/logo/Color-Rainbow-sm.png">
    <title>Aplikasi Extract Color</title>

    <link rel="apple-touch-icon" href="<?= base_url() ?>assets/img/logo/Color-Rainbow-sm.png">
    <link rel="shortcut icon" type="image/x-icon" href="<?= base_url() ?>assets/img/logo/Color-Rainbow-sm.png">
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Quicksand:300,400,500,700"
    rel="stylesheet">
    <link href="<?= assets_url ?>app-assets/fonts/line-awesome/css/line-awesome.min.css" rel="stylesheet">
...
data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
    ...
    <nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-without-dd-arrow fixed-top navbar-semi-dark navbar-shadow">
        <div class="navbar-wrapper">
            <div class="navbar-header <?= ($this->role=='admin'?'bg-danger':'bg-dark') ?>">
                <ul class="nav navbar-nav flex-row">
                <li class="nav-item mobile-menu d-md-none mr-auto"><a class="nav-link nav-menu-main menu-toggle hidden-xs" href="#"><i class="ft-menu font-large-1"></i></a></li>
                <li class="nav-item mr-auto">
                    <a class="navbar-brand" href="javascript:void(0)">
                    <img style="background: white; border-radius: 50px; padding: 3px;" class="brand-logo" alt="modern admin logo" src="<?= base_url() ?>assets/img/logo/Color-Rainbow-sm.png">
                    <h3 class="brand-text"><?= ucfirst($this->role) ?> Page</h3>
                    </a>
                </li>
